...
public class BookDAO {
    ...
    public static List<Book> getProductByCategoryID(Long cateID) {
        ...
        try {
            final String jpql = "SELECT b FROM Book b JOIN b.listCategory c WHERE c.category_id = :cateID";
    ...
    public static List<Book> searchByName(String name) {
        ...
        List<Book> books = null;
        try {
            final String sqlString = "SELECT b FROM Book b WHERE b.book_name LIKE :name";
